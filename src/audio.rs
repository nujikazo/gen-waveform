    ...
    T: Sample + SizedSample + FromSample<f32>,
{
    ...
    // Pre-fill the sample buffer with initial waveform data starting from phase 0
    {
        ...
        // For non-noise waveforms, generate exactly 3 cycles starting from phase 0
        if waveform != crate::oscillator::Waveform::Noise {
            let samples_per_cycle = (sample_rate / frequency) as usize;
            let total_samples = samples_per_cycle * 3;

            // Create a temporary oscillator starting at phase 0
            ...
            // Reset phase to ensure we start from 0
            temp_oscillator.reset_phase();
